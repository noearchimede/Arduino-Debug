...
-------------------------
\example debug_esempio_minimo.cpp
Esempio dell'utilizzo più semplice possibile della classe Debug.
\include lib/Debug/examples/debug_esempio_minimo.cpp
*/
...
class Debug {
  ...
  private:
    ...
    ///Riferimento a `Serial` per questa classe.
