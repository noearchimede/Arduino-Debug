...
void Debug::errFat() {
    ...
    _monitor.print(F("\tERRORE FATALE\n"));
...
void Debug::breakpoint(unsigned long attesaMassima) {
    ...
    //F("impostazione privata") di questa funzione: nr. di puntini per rappresentare
